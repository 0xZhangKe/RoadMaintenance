...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setBackgroundResource(R.drawable.select_gray_button_background_); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundResource(R.drawable.select_blue_button_background_);  //还原背景色
    }
}