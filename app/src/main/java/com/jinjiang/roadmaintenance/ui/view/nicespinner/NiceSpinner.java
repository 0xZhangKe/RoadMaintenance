package com.jinjiang.roadmaintenance.ui.view.nicespinner;
...
public class NiceSpinner extends TextView {
    ...
    public void onRestoreInstanceState(Parcelable savedState) {
        if (savedState instanceof Bundle) {
            ...
            if (mAdapter != null) {
                setText(mAdapter.getItemInDataset(mSelectedIndex).toString().trim());
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mListView.setDivider(getResources().getDrawable(R.color.divide));
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                setText(mAdapter.getItemInDataset(position).toString().trim());
                dismissDropDown();
            }
        });
    ...
    public <T> void attachDataSource(@NonNull List<T> dataset) {
        mAdapter = new NiceSpinnerAdapter<>(getContext(), dataset,tab);
    ...
    private void setAdapterInternal(@NonNull NiceSpinnerBaseAdapter adapter) {
        ...
        setText(adapter.getItemInDataset(mSelectedIndex).toString().trim());
    }
    ...
    public void showDropDown() {
        if (v!=null){
            ...
            location[1]= (int) (location[1]-v.getHeight()*3.6);
            mPopup.showAtLocation(v, Gravity.NO_GRAVITY, location[0], location[1]);
        }else {
            animateArrow(true);
    ...
    public  void setGravity(){
        Resources resources = getResources();
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.three_grid_unit);
        setGravity(Gravity.CENTER_VERTICAL | Gravity.CENTER_HORIZONTAL);
        setPadding(defaultPadding*3,defaultPadding, defaultPadding, defaultPadding);
        tab=1;
    }
    private boolean isSet = true;
    public  void setInitText(boolean isSet){
        this.isSet=isSet;
    }
